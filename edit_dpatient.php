...
<html lang = "en">
	...
	<div class = "well">
		...
		<div id = "p_fcovid" class = "panel panel-success">	
			<div class = "panel-heading">
			...
			<div class = "panel-body">
				<form id = "form_covid" action = "edit_patient.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" method = "POST" enctype = "multipart/form-data">
