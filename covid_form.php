		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<?php 
					...
					$f = $q->fetch_array();
				?>
				<label>covid RESULT FORM</label>	
				<a style = "float:right; margin-top:-4px;" href = "covid_record.php?itr_no=<?php echo $f['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
			</div>
