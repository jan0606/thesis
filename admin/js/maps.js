jQuery(document).ready(function($) {
    ...
    function getAllRoutesForMap() {
        ...
        showPermanentMessage('PUM and PUI Location');
    ...
    function deleteRoute() {
        if (hasMap()) {
            ...
            var answer = confirm("This will permanently delete  from the database. Do you want to delete?");
            if (answer){
            ...
            alert("Please select a PUM/PUI before trying to delete.");
        }
    }
